...
questions = [
    ...
    },
    {
        ...
        "choices": [
            ...
            Choice(name="Download a single song", value=ResultType.INDIVIDUAL), 
        ]
    },
    {
        "name": "playlist_url",
    ...
    },
    {
        "name": "song_name",
        "type": "input",
        "message": "Enter song name (Artist, Title):",
    ...
    },
    {
        ...
        "type": "filepath",
        "message": "Enter path of folder where you want songs to be downloaded:",
